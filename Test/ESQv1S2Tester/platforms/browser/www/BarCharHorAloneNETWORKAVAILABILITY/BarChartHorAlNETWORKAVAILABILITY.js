function netavaChart() {
  ...
  d3.json("BarCharHorAloneNETWORKAVAILABILITY/data.json", function(data) {
    ...
    bar.selectAll(".rectPercent").transition().ease("linear").duration(1000).delay(0).attr("width", function(d) { return x(d.frequency); });
