$(document).ready(function() {
  ...
  function ಠ_ಠ() {
    d3.json("AreaChartMonthlyTRANSACTION/data.json", function(datas) {
      drawLineChart(    'MonthTransaction',    datas.lineChart );
    });
  }
  ...
  function drawLineChart( elementId, data ) {
    ...
    var containerEl = document.getElementById( elementId ),
        ...
        svgContainer         = container.select( 'svg' )
                                .attr( 'width', $(".transMonthly").width() + 15 )
