$(document).ready(function() {
  ...
  var total;
  function ಠ_ಠ() {
    d3.json("AreaChartTodayTRANSACTION/data.json", function(datas) {
      drawLineChart(    'TodayTransaction',    datas.lineChart );
    });
  }
  ...
  function drawLineChart( elementId, data ) {
    ...
    var containerEl = document.getElementById( elementId ),
        ...
        svgContainer         = container.select( 'svg' )
                                .attr( 'width', $(".transToday").width()+40  )
