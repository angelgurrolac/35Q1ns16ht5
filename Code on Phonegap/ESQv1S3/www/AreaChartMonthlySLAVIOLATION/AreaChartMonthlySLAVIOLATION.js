$(document).ready(function() {
  ...
  function ಠ_ಠ() {
    d3.json("AreaChartMonthlySLAVIOLATION/data.json", function(datas) {
      drawLineChart(    'MonthSlaViolation',    datas.lineChart );
    });
  }
  ...
  function drawLineChart( elementId, data ) {
    ...
    var containerEl = document.getElementById( elementId ),
        BAR_PADDING = 0,
        width       = $('.slaMonthly').width(),
        height      = $('.slaToday').height(),
