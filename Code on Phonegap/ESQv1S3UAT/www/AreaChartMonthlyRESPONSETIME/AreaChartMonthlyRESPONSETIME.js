$(document).ready(function() {
  ...
  function ಠ_ಠ() {
    d3.json("AreaChartMonthlyRESPONSETIME/data.json", function(datas) {
      drawLineChart(    'MonthResponseT',    datas.lineChart );
    });
  }
