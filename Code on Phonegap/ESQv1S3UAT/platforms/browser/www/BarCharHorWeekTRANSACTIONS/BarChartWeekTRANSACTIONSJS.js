$(document).ready(function() {
  ...
  var svgCont = d3.select(".transWeek").append("svg")
      .attr({
        "width": width,
  ...
  d3.json("BarCharHorWeekTRANSACTIONS/data.json", function(error, data) {
    var diffDiary = 0;
    var diffWeekly = 0;
        ...
        .on('click', function(d, i, e) {
          ...
          svg.selectAll( '.too' ).remove();
            ...
            tooltip.append("text")
              ...
              .attr("y", 18)
              .text(function() {
                  if (d.transactions > 99999) {
                    formatNumber = d3.format("s");
                  }
                  return formatNumber(d.transactions) + " → ";
                });
            ...
            tooltip.append("text")
              ...
              .attr("x", 74)
              .attr("y", 18)
              .text(formatPercent((d.transactions / MaxValue)));
            ...
            //console.log(d.avgDiary);
            diffDiary = d.avgDiary - d.percentage;
            diffWeekly = d.avgWeekly - d.percentage;
