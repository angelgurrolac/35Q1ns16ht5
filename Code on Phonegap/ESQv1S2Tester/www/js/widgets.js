...
var COneValue, CtwoValue, CThreeValue, CFourValue, CFiveValue;
/*Disposals-Available*/
...
var isMenuOpen = false;
  ...
  $('#back, #feedback-link, #select-link, #about-link').click(function()
  {
    if (isMenuOpen === true)
    {
      $("#menu_smartphone").clearQueue().animate({
...
//Take Only the Numbers in the Array
function Numbermatch(v){
v=parseInt(v.match(/\d/g).join(""));
return v;
}

//Take Only Letters in the Array
function Valuematch(value){
value= value.toString().match(/[A-Z\s]/g).join("");
return value;
}
              ...
              "<div class='col-lg-5 col-md-5 col-sm-5 col-xs-5  info-ATL'>"+
                 "<ul class='ul-widgets'>"+
                  "<li class='li-active'><span>APPROVED</span>"+
                    "<ul class='ul-infow'>"+
                    "<li><span class='information-AA percent-margin'>"+Approved+"</span><span class='glyphicon glyphicon-triangle-top icon-up'></span><span class='info-percentu'>8%</span></li>"+
                    "</ul>"+
                  "</li>"+
                  "</ul>"+
                "</div>"+
      ...
      "<div id="+data.widgets.origin.id+" class='vertical col-lg-4 col-md-6 col-sm-6 col-xs-12 "+data.widgets.origin.name+"' style='position: relative; '>"+
        ...
        "<div class='widget-information widget-critical'>"+
            "<div class='col-lg-6 col-md-6 col-sm-6 col-xs-6 info-CF'>"+
              "<ul class='ul-widgets'>"+
              "<li class='li-one'><span class='percent-one'>"+COne+"%</span><span>"+COneValue+"</span></li>"+
              "</ul>"+
            "</div>"+

             "<div class='col-lg-6 col-md-6 col-sm-6 col-xs-6 info-CF'>"+
              "<ul class='ul-widgets'>"+
              "<li class='li-four'><span class='percent-four'>"+CFour+"%</span><span>" +CFourValue+"</span></li>"+
              "</ul>"+
            "</div>"+

            "<div class='col-lg-6 col-md-6 col-sm-6 col-xs-6 info-CF'>"+
              "<ul class='ul-widgets'>"+
              "<li class='li-two'><span class='percent-two'>"+Ctwo+"%</span><span>"+ CtwoValue+"</span></li>"+
              "</ul>"+
            "</div>"+

             "<div class='col-lg-6 col-md-6 col-sm-6 col-xs-6 info-CF'>"+
              "<ul class='ul-widgets'>"+
              "<li class='li-five'><span class='percent-five'>"+CFive+"%</span><span>"+ CFiveValue+"</span></li>"+
              "</ul>"+
            "</div>"+

            "<div class='col-lg-6 col-md-6 col-sm-6 col-xs-6 info-CF'>"+
              "<ul class='ul-widgets'>"+
              "<li class='li-three'><span class='percent-three'>"+CThree+"%</span><span>"+ CThreeValue+"</span></li>"+
              "</ul>"+
            "</div>"+
          "</div>"+
        "</div>"+
              ...
              "<div class='col-lg-5 col-md-5 col-sm-5 col-xs-5 info-DAL'>"+
                 "<ul class='ul-widgets'>"+
                  "<li><span class='accounting'>"+Instances[0]+"</span>"+
                    "<ul class='ul-infow'>"+
                    "<li><span class='currency'>"+Dis[0]+"</span><span class='information-AI'>/AVG. 280M</span></li>"+
                    "</ul>"+
                  "</li>"+
                  "</ul>"+
                "</div>"+
                "<div class='col-lg-5 col-md-5 col-sm-5 col-xs-5 info-DAR'>"+
                 "<ul class='ul-widgets'>"+
                  "<li><span class='accounting'>"+Instances[1]+"</span>"+
                    "<ul class='ul-infow'>"+
                    "<li><span class='currency'>"+Dis[1]+"</span><span class='information-AI'>/AVG. 241K</span></li>"+
                    "</ul>"+
                  "</li>"+
                "</ul>"+
                "</div>"+
                 ...
                 "<ul class='ul-widgets'>"+
                  "<li><span class='accounting'>"+Instances[2]+"</span>"+
                    "<ul class='ul-infow'>"+
                    "<li><span class='currency'>"+Dis[2]+"</span><span class='information-AI'></span></li>"+
                    "</ul>"+
                  "</li>"+
                  "</ul>"+
                "</div>"+
                "<div class='col-lg-5 col-md-5 col-sm-5 col-xs-5 info-DAR'>"+
                 "<ul class='ul-widgets'>"+
                  "<li><span class='accounting'>"+Instances[3]+"</span>"+
                    "<ul class='ul-infow'>"+
                    "<li><span class='currency'>"+Dis[3]+"</span><span class='information-AI'></span></li>"+
                    "</ul>"+
                  "</li>"+
                "</ul>"+
                "</div>"+
        ...
        "<a href='notification-settings-available.html'><span class='notification-config'></span></a>"+
            ...
            "<div class='widget-information'>"+
                "<div class='col-lg-5 col-md-5 col-sm-5 col-xs-5 info-DAL'>"+
                 "<ul class='ul-widgets'>"+
                  "<li><span class='accounting'>"+Instances[0]+"</span>"+
                    "<ul class='ul-infow'>"+
                    "<li><span class='currency'>"+Ava[0]+"</span><span class='information-AI'></span></li>"+
                    "</ul>"+
                  "</li>"+
                  "</ul>"+
                "</div>"+
                ...
                "<div class='col-lg-5 col-md-5 col-sm-5 col-xs-5 info-DAR'>"+
                 "<ul class='ul-widgets'>"+
                  "<li><span class='accounting'>"+Instances[1]+"</span>"+
                    "<ul class='ul-infow'>"+
                    "<li><span class='currency'>"+Ava[1]+"</span><span class='information-AI'></span></li>"+
                    "</ul>"+
                  "</li>"+
                "</ul>"+
                "</div>"+
                 ...
                 "<ul class='ul-widgets'>"+
                  "<li><span class='accounting'>"+Instances[2]+"</span>"+
                    "<ul class='ul-infow'>"+
                    "<li><span class='currency'>"+Ava[2]+"</span><span class='information-AI'></span></li>"+
                    "</ul>"+
                  "</li>"+
                  "</ul>"+
                "</div>"+
                ...
                "<div class='col-lg-6 col-md-6 col-sm-6 col-xs-6 info-DAR'>"+
                 "<ul class='ul-widgets'>"+
                  "<li><span class='accounting'>"+Instances[3]+"</span>"+
                    "<ul class='ul-infow'>"+
                    "<li><span class='currency'>"+Ava[3]+"</span><span class='information-AI'></span></li>"+
                    "</ul>"+
                  "</li>"+
                "</ul>"+
                "</div>"+
